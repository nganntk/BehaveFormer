...
# Example: 
# sh scripts/feta/ablation/test.sh <down/up> <acc/gyr> <0 (optional)>
#####################################################################
...
cmd="CUDA_VISIBLE_DEVICES=${cuda_device} python test.py --dataname feta -c ${config_file} --work_dirs_subfolder ablation/feta --metric basic"
echo $cmd
eval $cmd