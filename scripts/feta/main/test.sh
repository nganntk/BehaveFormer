...
# Example: sh scripts/feta/main/test.sh <down/up> <all/none> <0 (optional)>
############################################################################
...
cmd="CUDA_VISIBLE_DEVICES=${cuda_device} python test.py --dataname feta -c ${config_file} --metric basic det pca"
echo $cmd
eval $cmd