...
# Example: 
# sh scripts/humi/ablation/test.sh <down/up> <acc/gyr/mag/acc-gyr/acc-mag/gyr-mag> <0 (optional)>
##################################################################################################
...
cmd="CUDA_VISIBLE_DEVICES=${cuda_device} python test.py --dataname humi -c ${config_file} --work_dirs_subfolder ablation/humi --metric basic"
echo $cmd
eval $cmd